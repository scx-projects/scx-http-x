...
public class Http1ReaderTest {
    ...
    public static void test7() {
        ...
        var rawInput = createByteInput("GET /hello HTTP/1.1\r\n".getBytes());
        rawInput.close();
        Assert.assertThrows(InputAlreadyClosedException.class, () -> {
            var http1RequestLine = Http1Reader.readRequestLine(rawInput, 9999);
        });
    }
    ...
    public static void test8() {
        ...
        var rawInput = createByteInput(() -> {
            throw new ScxInputException("socket 异常");
        });
        Assert.assertThrows(ScxInputException.class, () -> {
            var http1RequestLine = Http1Reader.readRequestLine(rawInput, 9999);
        });
    }
    ...
    public static void test13() throws ContentLengthBodyTooLargeException {
        ...
        var byteSupplier = Http1Reader.createBodyByteSupplier((Http1Headers) new Http1Headers().contentLength(10), rawInput, 9999);
    ...
    public static void test14() {
        ...
        Assert.assertThrows(ContentLengthBodyTooLargeException.class, () -> {
            var byteSupplier = Http1Reader.createBodyByteSupplier((Http1Headers) new Http1Headers().contentLength(999), rawInput, 100);
        });
    }
    ...
    public static void test16() throws ContentLengthBodyTooLargeException {
        ...
        var byteSupplier = Http1Reader.createBodyByteSupplier(new Http1Headers().transferEncoding(CHUNKED), rawInput, 100);
    ...
    public static void test17() throws ContentLengthBodyTooLargeException {
        ...
        // 长度太长
        var byteSupplier = Http1Reader.createBodyByteSupplier(new Http1Headers().transferEncoding(CHUNKED), rawInput, 5);
    ...
    public static void test18() throws ContentLengthBodyTooLargeException {
        ...
        var byteSupplier = Http1Reader.createBodyByteSupplier(new Http1Headers().transferEncoding(CHUNKED), rawInput, 1000);
    ...
    public static void test23_exceedMaxLength() throws ContentLengthBodyTooLargeException {
        ...
        b.close();
        var rawInput = createByteInput(a.bytes());
        var byteSupplier = Http1Reader.createBodyByteSupplier(new Http1Headers().transferEncoding(CHUNKED), rawInput, 5); // 限制 maxLength=5
        var bodyInput = createByteInput(byteSupplier);
    ...
    @Test
    public static void test30_multipleTinyChunks() throws ScxInputException, InputAlreadyClosedException, NoMoreDataException, ContentLengthBodyTooLargeException {
        var a = new ByteArrayByteOutput();
        var b = new HttpChunkedByteOutput(a);
    ...
    @Test
    public static void test31_singleChunkExactlyMaxLength() throws ScxInputException, InputAlreadyClosedException, NoMoreDataException, ContentLengthBodyTooLargeException {
        ...
        // maxLength 恰好等于内容长度
        var byteSupplier = Http1Reader.createBodyByteSupplier(new Http1Headers().transferEncoding(CHUNKED), rawInput, content.length());
        var bodyInput = createByteInput(byteSupplier);
    ...
    @Test
    public static void test32_zeroLengthChunkNormal() throws ScxInputException, InputAlreadyClosedException, NoMoreDataException, ContentLengthBodyTooLargeException {
        // 正确的 0 长度 chunk
        var rawInput = createByteInput("0\r\n\r\n".getBytes());
        var byteSupplier = Http1Reader.createBodyByteSupplier(new Http1Headers().transferEncoding(CHUNKED), rawInput, 10);
        var bodyInput = createByteInput(byteSupplier);
        var data = new String(bodyInput.readAll());
    ...
    @Test
    public static void test33_singleByteChunk() throws ScxInputException, InputAlreadyClosedException, NoMoreDataException, ContentLengthBodyTooLargeException {
        // 单字节 chunk
        var a = new ByteArrayByteOutput();
        var b = new HttpChunkedByteOutput(a);
        b.write("x".getBytes());
    ...
    @Test
    public static void test34_multipleVariableChunks() throws ScxInputException, InputAlreadyClosedException, NoMoreDataException, ContentLengthBodyTooLargeException {
        // 多个大小不同的 chunk
        var a = new ByteArrayByteOutput();
        var b = new HttpChunkedByteOutput(a);
    ...
    @Test
    public static void test35_fragmentedStream() throws ScxInputException, InputAlreadyClosedException, NoMoreDataException, ContentLengthBodyTooLargeException {
        // 模拟网络分片读取，每次只提供 1 字节
    ...
    @Test
    public static void test37_largeChunkWithinMaxLength() throws ScxInputException, InputAlreadyClosedException, NoMoreDataException, ContentLengthBodyTooLargeException {
        // 单块很大，但未超过 maxLength
        ...
        b.close();
        var rawInput = createByteInput(a.bytes());
        var byteSupplier = Http1Reader.createBodyByteSupplier(new Http1Headers().transferEncoding(CHUNKED), rawInput, 20);
        var bodyInput = createByteInput(byteSupplier);
        var data = new String(bodyInput.readAll());
        Assert.assertEquals(data, content);
    }
