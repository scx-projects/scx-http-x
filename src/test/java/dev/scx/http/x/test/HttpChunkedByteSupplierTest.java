...
public class HttpChunkedByteSupplierTest {
    ...
    public static void main(String[] args) throws ScxInputException {
        testGet();
        testFail();
        testFail2();
        testFail3();
    ...
    @Test
    public static void testGet() throws ScxInputException {
        // 模拟的复杂分块数据
        byte[] mockData = ("4\r\nWiki\r\n3\r\nHel\r\n7\r\nloWorld\r\n0\r\n\r\n").getBytes();
    ...
    @Test
    public static void testFail() throws ScxInputException {
        // 模拟的复杂分块数据
        byte[] mockData = ("4\r\nWiki\r\n3\r\nHel\r\n7\r\nloWorld\r\n0\r\n\r").getBytes();
        var byteArrayByteReader = createByteInput(new ByteArrayByteSupplier(mockData));
    ...
    @Test
    public static void testFail2() throws ScxInputException {
        // 模拟的复杂分块数据
        byte[] mockData = ("4\r\nWiki\r\n3\r\nHel\r\n7\r\nloWorld\r\n0\r\n???\r\n").getBytes();
        var byteArrayByteReader = createByteInput(new ByteArrayByteSupplier(mockData));
    ...
    @Test
    public static void testFail3() throws ScxInputException {
        // 模拟的复杂分块数据
        byte[] mockData = ("4\r\nWiki\r\n?\r\nHel\r\n7\r\nloWorld\r\n0\r\n\r\n").getBytes();
        var byteArrayByteReader = createByteInput(new ByteArrayByteSupplier(mockData));
