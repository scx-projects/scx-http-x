...
public final class Http1ClientResponseByteInput implements ByteInput {
    ...
    private final Http1RequestLine requestLine;
    private final Http1StatusLine statusLine;
    private final Http1Headers responseHeaders;
    private boolean closed;

    public Http1ClientResponseByteInput(Http1ClientConnection connection, Http1RequestLine requestLine, Http1StatusLine statusLine, Http1Headers responseHeaders) {
    ...
    public void close() throws ScxInputException {
        ...
        connection.onResponseEnd(requestLine, statusLine, responseHeaders);
